...
public class ServicioDocenteImpl implements ServicioDocente {
    ...
    public void asignarDocenteAsesor(Long practicaId) {
        InstanciaPractica practica = instanciaPracticaRepository.findByIdWithExpedienteAndEstudiante(practicaId)
        ...
        if (candidatos.isEmpty()) {
            throw new NegocioException(
                    "No hay docentes asesores activos disponibles para el programa del estudiante (id programa: "
                            + programaId + ").");
        }
