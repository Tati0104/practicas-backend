...
public class SeguimientoServiceProxy implements SeguimientoService {
    ...
    public List<TableroResponse> obtenerPracticasSeguimiento(
        ...
        return realService.obtenerPracticasSeguimiento(busqueda, programaId, estadoSeguimiento, estadoPractica);
    }

    @Override
    public List<TableroResponse> obtenerHistorialPracticasEstudiante(Long estudianteId) {
        return realService.obtenerHistorialPracticasEstudiante(estudianteId);
    }
