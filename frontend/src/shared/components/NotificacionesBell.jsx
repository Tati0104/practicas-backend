  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-primary"
      ...
      {abierto && (
        <div className="absolute right-0 top-[calc(100%+8px)] z-50 w-80 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl">
          ...
          <div className="max-h-80 overflow-y-auto p-2">
            {isLoading && <p className="py-6 text-center text-sm text-gray-400">Cargando...</p>}
            ...
            {alertas.map((a) => (
              <div
                ...
                className={[
                  ...
                  a.leida ? 'border-gray-100 bg-gray-50' : 'border-amber-200 bg-amber-50',
              ...
              >
                ...
                <div className="mt-2 flex items-center justify-between gap-2">
                  <span className="text-[11px] text-gray-400">{a.fecha}</span>
                  {!a.leida && (
                    <button
                      type="button"
